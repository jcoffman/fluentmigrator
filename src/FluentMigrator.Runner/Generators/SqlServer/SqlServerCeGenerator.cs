...
namespace FluentMigrator.Runner.Generators.SqlServer
{
    public class SqlServerCeGenerator : SqlServer2000Generator
    {
        ...
        public override string CreateIndex { get { return "CREATE {0}{1}INDEX {2} ON {3} ({4})"; } }
        public override string DropIndex { get { return "DROP INDEX {0} ON {1}"; } }

        public override string InsertData { get { return "INSERT INTO {0} ({1}) VALUES ({2})"; } }
        ...
        {
            return String.Format("DROP INDEX {1}", Quoter.QuoteTableName(expression.Index.TableName), Quoter.QuoteIndexName(expression.Index.Name));
        }

        public override string Generate(CreateTableExpression expression)
        {
            return string.Format("CREATE TABLE {0}", base.Generate(expression));
        }
        ...
        public override string Generate(DeleteDataExpression expression)
        {
            ...
            {
                deleteItems.Add(string.Format(DeleteData, 
        ...
        public override string Generate(AlterDefaultConstraintExpression expression)
        {
            ...
            builder.Append(
                String.Format("-- create alter table command to create new default constraint as string and run it\r\nALTER TABLE {0} WITH NOCHECK ADD CONSTRAINT {3} DEFAULT({2}) FOR {1};",
                Quoter.QuoteTableName(expression.TableName),
